...
- **Web 版竖屏视频封面拉伸** — 封面提取误用 `getCodedWidth/Height`（编码尺寸），
  ...
  （[#6](https://github.com/NewbieCheng/oppo-live-photo-maker/issues/6)）
...
[Unreleased]: https://github.com/NewbieCheng/oppo-live-photo-maker/compare/v0.1.1...HEAD
[0.1.1]: https://github.com/NewbieCheng/oppo-live-photo-maker/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/NewbieCheng/oppo-live-photo-maker/releases/tag/v0.1.0
